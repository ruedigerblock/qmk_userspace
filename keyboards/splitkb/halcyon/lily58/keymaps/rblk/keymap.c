...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT_lily58_hlc(
            ...
            _______,    _______,    _______,    _______,    _______,    _______,                            KC_BRID,    KC_BRIU,    KC_VOLD,    KC_VOLU,    _______,    _______,
            _______,    _______,    _______,    _______,    _______,    _______,                            KC_7,       KC_8,       KC_9,       S(KC_0),    _______,    _______,
            _______,    _______,    _______,    _______,    _______,    _______,                            KC_4,       KC_5,       KC_6,       DE_MINS,    _______,    _______,
            _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_1,       KC_2,       KC_3,       DE_PLUS,    _______,    _______,
