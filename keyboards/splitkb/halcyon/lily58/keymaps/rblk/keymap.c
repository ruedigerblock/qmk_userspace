...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_lily58_hlc(
            ...
            LT(5, KC_ESC),  KC_1,       KC_2,       KC_3,       KC_4,       KC_5,                                       KC_6,       KC_7,       KC_8,       KC_9,       KC_0,       KC_BSPC,
            ...
            KC_LCTL,        KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       MO(2),          MO(3),          KC_N,       KC_M,       KC_COMM,    KC_DOT,     DE_MINS,    QK_LEAD,
                                                    KC_LCTL,    KC_LGUI,    KC_LALT,    LT(1, KC_SPC),  LT(4, KC_SPC),  KC_RALT,    KC_RGUI,    KC_RCTL,
    ...
    [4] = LAYOUT_lily58_hlc(
            ...
            DE_CIRC,    _______,    _______,    _______,    _______,    _______,                            _______,    _______,    _______,    _______,    DE_BSLS,    _______,
            _______,    DE_AT,      _______,    DE_EURO,    _______,    _______,                            _______,    _______,    _______,    _______,    DE_TILD,    DE_PIPE,
            _______,    DE_PIPE,    DE_LABK,    DE_LBRC,    DE_LCBR,    S(DE_8),                            S(DE_9),    DE_RCBR,    DE_RBRC,    S(DE_LABK), _______,    _______,
    ...
    [5] = LAYOUT_lily58_hlc(
            ...
            _______,    _______,    _______,    _______,    _______,    _______,                            _______,    _______,    _______,    _______,    DE_ACUT,    KC_DEL,
            _______,    _______,    _______,    _______,    _______,    _______,                            _______,    DE_UDIA,    _______,    DE_ODIA,    _______,    DE_MINS,
